...
grand_qty = sum(item["Qty"] for item in produk_terpilih)
grand_total = sum(item["Total"] for item in produk_terpilih)

col1, col2 = st.columns(2)

with col1:
    st.success(f"📦 Total Produk: {grand_qty} pcs")

with col2:
    st.info(f"💰 Total Omzet: Rp {grand_total:,}")
